...
import { ManualSignUpFormA } from "./manual-form-a";
import { ManualSignUpFormB } from "./manual-form-b";
        ...
        >
          <div className="flex gap-6 flex-nowrap ">
            <FormProvider {...form}>
              ...
              <ManualSignUpFormB />
              <SignUpPage>
                <OTPForm email={form.getValues().email} />
              </SignUpPage>
            </FormProvider>
          </div>
        </div>
  ...
  return (
    ...
    >
      <CardHeader className="text-center">
        <CardTitle className="text-xl">Welcome to Aceternity</CardTitle>
        <CardDescription>Login to aceternity if you can</CardDescription>
      </CardHeader>
      <CardContent className="p-0">
        <div className="w-full relative overflow-hidden">
          <div className="p-6 pt-0 grid gap-6 w-full">
